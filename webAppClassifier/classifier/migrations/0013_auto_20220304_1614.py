    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expected_result', models.CharField(blank=True, default='', max_length=100)),
                ('prediction_feedback', models.BooleanField(blank=True, default=False)),
                ('imagine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='classifier.prediction')),
            ],
        ),
    ]
